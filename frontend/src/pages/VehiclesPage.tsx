...
function getVehicleCustomer(
  ...
  return customers.find((customer) => customer.id === vehicle.clientId);
}
                ...
                return (
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      <h3 className="font-mono text-sm font-black uppercase tracking-wider text-blue-700">
                        {vehicle.plate}
                      </h3>
        ...
        {selectedVehicle ? (
            ...
            <div className="rounded-3xl border border-slate-200/80 bg-white p-6 shadow-sm">
              <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex items-center gap-4">
                  <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-slate-900 to-blue-900 text-white shadow-md">
                    <Car className="h-7 w-7" />
                  </div>

                  <div>
                    <h2 className="font-mono text-xl font-black uppercase tracking-wider text-blue-700">
                      {selectedVehicle.plate}
                    </h2>

                    <p className="mt-1 text-xs font-medium text-slate-500">
                      {selectedVehicle.note || "Araç notu bulunmuyor"}
                    </p>
                  </div>
                </div>

                <div className="rounded-2xl border border-blue-100 bg-blue-50 p-4 text-center sm:min-w-36">
                      ...
                      <div className="min-w-0">
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          <span className="rounded-lg border border-amber-100 bg-amber-50 px-2.5 py-1 font-mono text-[10px] font-black uppercase text-amber-700">
                            Raf: {record.storageLocation || "Girilmedi"}
                          </span>
                        </div>
          ...
          <div className="flex min-h-[620px] flex-col items-center justify-center rounded-3xl border border-slate-200/80 bg-white p-12 text-center shadow-sm">
            ...
            <p className="mt-2 max-w-sm text-xs leading-relaxed text-slate-400">
              Detayları görüntülemek için soldaki listeden bir araç seçin.
            </p>
          </div>
        )}
      </section>
